...
class Step5StartMonthYearPage extends StatelessWidget {
  const Step5StartMonthYearPage({super.key});
          ...
          body: Column(
            ...
            children: [
              ...
              _MonthYearPicker(
                ...
                selectedDate: draft.startMonthYear,
                onDateSelected: cubit.updateStartMonthYear,
              ),
            ],
          ),
          bottom: FunButton(
            text: locals.externalDonationsCreateConfirmButton,
            isDisabled: !draft.isStartMonthYearValid,
            isLoading: uiModel.isSubmitting,
            analyticsEvent: AnalyticsEventName.externalDonationsCreateConfirmClicked
                .toEvent(),
            onTap: draft.isStartMonthYearValid && !uiModel.isSubmitting
                ? cubit.continueFromStartMonthYear
                : null,
          ),
        );
      },
...
class _MonthYearPickerState extends State<_MonthYearPicker> {
  ...
  @override
  void didUpdateWidget(_MonthYearPicker oldWidget) {
  ...
  Widget build(BuildContext context) {
    return FunInput(
      ...
      readOnly: true,
      hintText: context.l10n.externalDonationsCreateSelectMonthYearHint,
      ...
      onTap: () async {
        ...
        if (picked != null) {
          widget.onDateSelected(DateTime(picked.year, picked.month));
        }
      },
    );
  }
