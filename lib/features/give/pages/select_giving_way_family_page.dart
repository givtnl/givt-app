...
class SelectGivingWayFamilyPage extends StatelessWidget {
  const SelectGivingWayFamilyPage({super.key});
                  ...
                  children: [
                    ...
                    _buildListTile(
                      onTap: () => context.goNamed(
                        FamilyPages.giveByBeaconFamily.name,
                        extra: context.read<GiveBloc>(),
                      ),
                    ...
                    _buildListTile(
                      onTap: () => context.goNamed(
                        FamilyPages.giveByQrCodeFamily.name,
                        extra: context.read<GiveBloc>(),
                      ),
                    ...
                    _buildListTile(
                      onTap: () => context.goNamed(
                        FamilyPages.giveByLocationFamily.name,
                        extra: context.read<GiveBloc>(),
                      ),
