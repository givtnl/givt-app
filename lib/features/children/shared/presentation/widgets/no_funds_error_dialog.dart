...
class NoFundsErrorDialog extends StatelessWidget {
  const NoFundsErrorDialog({this.onClickRetry, super.key});

  final void Function()? onClickRetry;

  static void show(BuildContext context, {void Function()? onClickRetry}) {
    showDialog<void>(
      barrierDismissible: false,
      context: context,
      builder: (context) => NoFundsErrorDialog(onClickRetry: onClickRetry),
    );
  }
