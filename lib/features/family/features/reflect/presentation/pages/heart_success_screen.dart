...
class HeartSuccessScreen extends StatefulWidget {
  const HeartSuccessScreen({
    super.key,
    this.orgName,
  ...
  @override
  State<HeartSuccessScreen> createState() => _SuccessScreenState();
}

class _SuccessScreenState extends State<HeartSuccessScreen> {
  @override
  void initState() {
    super.initState();
