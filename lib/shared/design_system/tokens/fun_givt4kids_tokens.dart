// When design-tokens/source/givt4kids.tokens.json is present, run: dart run tool/gen_tokens.dart
// to regenerate this file from the token JSON. Until then, this hand-written implementation is used.

import 'package:flutter/material.dart';
import 'package:givt_app/shared/design_system/tokens/fun_theme_tokens.dart';

/// Givt4Kids design tokens (teal primary, Rouna font, orange-tinted secondary).
class FunGivt4KidsTokens implements FunThemeTokens {
  FunGivt4KidsTokens._();
  static final FunGivt4KidsTokens instance = FunGivt4KidsTokens._();

  @override
  Color get primaryColor => const Color(0xFF00696A);
  @override
  Color get secondaryColor => const Color(0xFF914C00);
  @override
  Color get tertiaryColor => const Color(0xFF744AA5);

  @override
  Color get primary10 => const Color(0xFF002020);
  @override
  Color get primary20 => const Color(0xFF003737);
  @override
  Color get primary30 => const Color(0xFF004F50);
  @override
  Color get primary40 => const Color(0xFF00696A);
  @override
  Color get primary50 => const Color(0xFF00696A);
  @override
  Color get primary60 => const Color(0xFF4CDADB);
  @override
  Color get primary70 => const Color(0xFF6FF6F7);
  @override
  Color get primary80 => const Color(0xFFAEFFFF);
  @override
  Color get primary90 => const Color(0xFF6FF6F7);
  @override
  Color get primary95 => const Color(0xFFE2FFFE);
  @override
  Color get primary98 => const Color(0xFFE2FFFE);
  @override
  Color get primary99 => const Color(0xFFF1FFFE);

  @override
  Color get secondary10 => const Color(0xFF4E2600);
  @override
  Color get secondary20 => const Color(0xFF6F3900);
  @override
  Color get secondary30 => const Color(0xFF914C00);
  @override
  ...
  @override
  Color get secondary90 => const Color(0xFFFFDCC3);
  @override
  Color get secondary95 => const Color(0xFFFFEDE3);
  @override
  Color get secondary98 => const Color(0xFFFFEDE3);
  @override
  Color get secondary99 => const Color(0xFFFFEDE3);
  ...
  @override
  String get fontFamily => 'Rouna';

  @override
  FontWeight get fontWeightStrong => FontWeight.w700; // Bold for Rouna
  ...
  @override
  double get borderWidthThicker => 6;

  @override
  double get shadowYNone => 0;
  @override
  double get shadowYXs => 2;
  @override
  double get shadowYSm => 4;
  @override
  double get shadowYMd => 6;
  @override
  double get shadowYLg => 8;
  @override
  double get shadowYXl => 10;
}
