...
enum AmplitudeEvents {
  ...
  qrCodeCreateButtonPressed('qr_code_create_button_pressed'),
  qrCodeCreated('qr_code_created'),
  qrCodeTabSwitched('qr_code_tab_switched'),
  qrCodeActivatePressed('qr_code_activate_pressed'),
  qrCodeDeactivatePressed('qr_code_deactivate_pressed'),
  qrCodeDownloadPressed('qr_code_download_pressed'),
