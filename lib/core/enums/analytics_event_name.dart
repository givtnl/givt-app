...
enum AnalyticsEventName {
  ...
  forYouSearchTapped('for_you_search_tapped'),
  forYouOtherWaysLocationTapped('for_you_other_ways_location_tapped'),
  ...
  forYouDoorToDoorSuggestionTapped('for_you_door_to_door_suggestion_tapped'),
  ...
  forYouQrInactiveCancelTapped('for_you_qr_inactive_cancel_tapped'),
  forYouQrInactiveYesPleaseTapped('for_you_qr_inactive_yes_please_tapped'),
  forYouQrNonGivtTryAgainTapped('for_you_qr_non_givt_try_again_tapped'),
  forYouQrNonGivtLeaveTapped('for_you_qr_non_givt_leave_tapped'),
  ...
  platformContributionNavigationClicked(
    'platform_contribution_navigation_clicked',
  ),
  ...
  platformContributionSaveChangesClicked(
    'platform_contribution_save_changes_clicked',
  ),
  platformContributionSaveConfirmClicked(
    'platform_contribution_save_confirm_clicked',
  ),
  platformContributionDiscardConfirmClicked(
    'platform_contribution_discard_confirm_clicked',
  ),
  ...
  emailTypoSuggestionAccepted('email_typo_suggestion_accepted'),
  emailTypoSuggestionDismissed('email_typo_suggestion_dismissed');
