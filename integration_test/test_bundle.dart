...
import 'eu_login_test.dart' as eu_login_test;
import 'us_login_test.dart' as us_login_test;
...
Future<void> main() async {
  ...
  group('eu_login_test', eu_login_test.main);
  group('us_login_test', us_login_test.main);
